        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassengerSurname = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PassengerAge = table.Column<byte>(type: "tinyint", nullable: false),
                    ReservationId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AirRoutes_DepartureAirportId_ArrivalAirportId_AircraftId",
                table: "AirRoutes",
                columns: new[] { "DepartureAirportId", "ArrivalAirportId", "AircraftId" },
                unique: true);
